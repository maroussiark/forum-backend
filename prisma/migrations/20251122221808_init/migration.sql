...
*/
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('POST_CREATED', 'POST_COMMENTED', 'POST_REACTED', 'COMMENT_REACTED', 'COMMENT_REPLIED', 'MESSAGE_RECEIVED', 'CONVERSATION_JOINED', 'PROFILE_UPDATED', 'SYSTEM');

-- CreateEnum
CREATE TYPE "EntityType" AS ENUM ('POST', 'COMMENT', 'MESSAGE', 'CONVERSATION', 'PROFILE');
